      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-2">
            <Link to="/" className="flex items-center gap-2.5 mb-4">
              ...
              <span className="text-xl font-bold text-white">Edcare4u</span>
            </Link>
            <p className="text-sm text-gray-400 leading-relaxed">
              Transform your study materials into interactive quizzes with the power of AI. Learn smarter, not harder.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <a href="/#upload" className="text-sm hover:text-white transition-colors">Get Started</a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-500">
            &copy; {currentYear} Edcare4u. All rights reserved.
          </p>
